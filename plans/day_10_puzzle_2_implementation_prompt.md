```
Build a plan for implementing the solution to day 10 puzzle 2. Use the patterns established inside this project to implement the solution and add unit tests.
All code must confirm to the StyleCop rules. Doc comments for the class and the methods are not necessary.
Update GetPuzzleInstance_WithAllImplementedDays_ShouldReturnInstances inside @AdventOfCode2025.Tests/PuzzleFactoryTests.cs to include this day if needed. Refactor any duplicate code into resuable methods.

Here is some background information. Below is day 10 puzzle 1. It is provided as background information when planning for puzzle 2. The plan for puzzle 1 is in @plans/day_10_puzzle_1_implementation.md.
